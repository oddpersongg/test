...
/* 0x10 shared sub-service response function (reads the sub from the request;
   referenced by Bl_UdsService_Lcfg.c for every 0x10 sub-service) */
...
/* 0x11 shared sub-service response function (respond-then-reset, reads the
   reset type from the request; referenced by Bl_UdsService_Lcfg.c) */
